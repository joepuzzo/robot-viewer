...
console.log('PROJ_0_1 --------------------------------------------------');
printMatrix(r0_1_proj);
console.log('PROJ_1_2 --------------------------------------------------');
printMatrix(r1_2_proj);
console.log('PROJ_2_3 --------------------------------------------------');
printMatrix(r2_3_proj);
console.log('PROJ_3_4 --------------------------------------------------');
printMatrix(r3_4_proj);
console.log('PROJ_4_5 --------------------------------------------------');
printMatrix(r4_5_proj);
console.log('PROJ_5_6 --------------------------------------------------');
printMatrix(r5_6_proj);
